...
public class WeatherClientToResponseConverterTest {
    ...
    public static void setup() {
        DateTimeUtils.setCurrentMillisFixed(DateTime.parse("2022-11-19T19:19+05:30").getMillis());
    }
    ...
    void verifyChangeInThresholdsChangesAdvises() throws Exception {
        ...
        // then
        assertNotNull(dest);
        assertNotNull(dest.getDays().get("2022-11-20"));
    ...
    @Test
    void verifyPresentDayIsEvaluatedWhenLocalTimeWithinCutoffSet() throws Exception {
        // given
        WeatherClientToResponseConverter converter = new WeatherClientToResponseConverter(2, 300, 1, 3600);
        ...
        assertNotNull(dest);
        assertNotNull(dest.getDays().get("2022-11-20"),
                "Current local time is within cutoff. Forecast MUST start from present day.");
    }
